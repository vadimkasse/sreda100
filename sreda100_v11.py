...
# Pass 2: secondary effects (distort the result of pass 1)
# drift and gravity only here
SECONDARY_EFFECTS = ["chaos", "earthquake", "twist", "shatter", "drift", "gravity"]
SECONDARY_WEIGHTS = [3, 3, 2, 2, 4, 3]
...
def generate(day, seed=None, glitch=False):
    ...
    # Pass 2: warp the result of pass 1
    ...
    fname = (f"{e1}+{e2}_t{int(t1*100)}+{int(t2*100)}"
